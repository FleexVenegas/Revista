  ...
  <div>
    <div className="mb-10">
      ...
      <p className="text-justify text-lg">
        ...
        en los números correspondientes al año 2019.
      </p>
    </div>
  </div>
);
  ...
  <div className="p-4">
    <div className="mb-10">
      <div className="md:w-4/5 p-5 bg-slate-100 dark:bg-gray-500 rounded-2xl opacity-90">
        ...
        <p className="text-justify text-lg">
          La Revista Internacional de Investigación y Formación Educativa
          (RIIFEDUC) es una publicación con periodicidad trimestral, que
          ...
          revista de carácter transdisciplinario y transteórico. La RIIFEDUC es
    ...
    <div className="mb-10">
      <div className="md:w-4/5 bg-slate-100 dark:bg-gray-500 rounded-2xl p-5 opacity-90">
        ...
        <p className="text-justify text-lg">
          El envío será vía correo electrónico al email: riifeduc@gmail.com.
